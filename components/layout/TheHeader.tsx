...
export default () => {
  ...
  const navigation = [
    { title: "Movimentos", path: "/movements" },
    { title: "Impressoras", path: "/printers" },
    { title: "Toners", path: "/supplies/toners" },
    { title: "Cilindros", path: "/supplies/drums" },
    { title: "Fabricantes", path: "/brands" },
  ];
    ...
    <nav className="w-full border-b bg-white md:static md:border-0">
      <div className="mx-auto max-w-screen-xl items-center px-4 md:flex md:px-8">
        <div className="flex items-center justify-between py-3 md:block md:py-5">
          <a href="/">
            <h2 className="text-lg">Printer Supplies</h2>
          </a>
